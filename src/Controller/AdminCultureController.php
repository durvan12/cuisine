...
class AdminCultureController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('admin_culture/new.html.twig', [
            'culture' => $culture,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('admin_culture/show.html.twig', [
            'culture' => $culture,
        ]);
    }
    ...
    public function edit(Request $request, Culture $culture, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('admin_culture/edit.html.twig', [
            'culture' => $culture,
            'form' => $form,
        ]);
    }
